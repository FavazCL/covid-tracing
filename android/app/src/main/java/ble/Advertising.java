...
public class Advertising {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
      ...
      if (compatible) {
        ...
        AdvertiseData data = (new AdvertiseData.Builder())
                .addServiceUuid(new ParcelUuid(Contants_Ble.GATT_SERVICE_UUID))
                .addServiceData(new ParcelUuid(Contants_Ble.GATT_SERVICE_UUID), getAdvertiseData(ephid))
                .build();
  ...
  private AdvertiseData buildAdvertiseData(byte[] ephid) {
    ...
    dataBuilder.addServiceUuid(new ParcelUuid(Contants_Ble.GATT_SERVICE_UUID));
    dataBuilder.addServiceData(new ParcelUuid(Contants_Ble.GATT_SERVICE_UUID), getAdvertiseData(ephid));
