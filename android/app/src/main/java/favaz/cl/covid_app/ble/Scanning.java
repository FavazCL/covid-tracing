...
import favaz.cl.covid_app.database.Database;
import favaz.cl.covid_app.models.EphId;
...
public class Scanning {
  ...
  private List<ScanFilter> buildScanFilters() {
    ...
    filters.setServiceUuid(new ParcelUuid(Constants.GATT_SERVICE_UUID));
  ...
  private void onDeviceFound(ScanResult scanResult) {
    try {
      ...
      byte[] payload = scanResult.getScanRecord().getServiceData(new ParcelUuid(Constants.GATT_SERVICE_UUID));
